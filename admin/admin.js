function currency(num) {
	...
	function searchproduct(){
		...
		var s='<tr><th>ID</th><th>Ảnh</th><th>TÊN SẢN PHẨM</th><th>THƯƠNG HIỆU</th><th>GIÁ</th></tr>';
			if (brand=='all') {
				if(!name){
					showProductList(0);
				}
	...
	function addProduct(){
		var productArray = JSON.parse(localStorage.getItem('product')) || [];
		var productid = productArray.length > 0 ? productArray[0].productId + 1 : 1;  // Tính toán productId
